...
<body>
	<div class="container" id="wrapper">
		<div id="header">
			 <div class="logo" style="margin-top:-40px;margin-bottom:8px;"><img src="images/log.png" width="60px" height="50px"/>Bhartiya <span> Police</span></div>
		</div>
...
<div class="row" >
	 <div class="col-sm-3"></div>
		...
		<p style="margin-top:5px;">Copyright &copy; Speak up <a href="#" title="email">By Monish Kumar Sahu</a>  </p>
