        ...
        if ($_FILES){
          ...
          if ($ext){
             ...
             if ($file_size < 1000000){
               ...
               $name = "C:\\xamppp\\htdocs\\crimeg\\Uploads\\missing_persons\\$name";
               $new = "C:\\xamppp\\htdocs\\crimeg\\Uploads\\missing_persons\\_".$file_name;
        ...
        if ($_FILES){
          ...
          if ($ext){
             ...
             if ($file_size < 1000000){
               ...
               $name = preg_replace("[^A-Za-z0-9.]", "", $name);
               $name = strtolower($name);
               $name = "C:\\xamppp\\htdocs\\crimeg\\Uploads\\missing_vehicles\\$name";
               $new = "C:\\xamppp\\htdocs\\crimeg\\Uploads\\missing_vehicles\\_".$file_name;
