...
?>
	<div class="container" id="wrapper">
		<div id="header">
			<div class="mainLogo">
           			 <div class="logo"><img src="images/log.png" width="60px" height="50px"/>Bhartiya <span> Police</span></div>
       	    </div>
			<div id="login">
    ...
    <div id="slider1_container" style="position:relative;top: 0px; left: 0px; width: 810px; height: 420px; background: #000; overflow: hidden; ">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 390px;
            ...
            <div>
                <img u="image" src="images/slidder1.jpg" />
                <div u="thumb">
            ...
            <div>
                <img u="image" src="images/slidder2.jpg" />
                <div u="thumb">
            ...
            <div>
                <img u="image" src="images/slidder4.jpg" />
                <div u="thumb">
            ...
            <div>
                <img u="image" src="images/slidder3.jpg" />
                <div u="thumb">
			...
			<div>
                <img u="image" src="images/choppper.jpg" />
                <div u="thumb">
